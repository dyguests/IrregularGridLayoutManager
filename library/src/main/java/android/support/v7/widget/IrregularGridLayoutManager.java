...
/**
 * Most Code is copy from GridLayoutManager.
 * <p>
 * Created by fanhl on 15/12/4.
 */
public class IrregularGridLayoutManager extends LinearLayoutManager {
     ...
     */
    public IrregularGridLayoutManager(Context context, AttributeSet attrs, int defStyleAttr,
                                      int defStyleRes) {
     ...
     */
    public IrregularGridLayoutManager(Context context, int spanCount) {
        super(context);
     ...
     */
    public IrregularGridLayoutManager(Context context, int spanCount, int orientation,
    ...
    private int getSpanDividerWidth(int index) {
        if (mSpanDividers == null || index < 0 || index >= mSpanDividers.length) {
            return 0;
        }
     ...
     *
     * @see IrregularGridLayoutManager#setSpanSizeLookup(SpanSizeLookup)
     */
